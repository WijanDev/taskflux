...
type MonthCalendarViewProps = {
  ...
  readonly onDaySelect?: (day: Date) => void
}
...
type MonthDaySectionProps = {
  ...
  readonly onTaskSelect: (task: Task) => void
  readonly onDaySelect?: (day: Date) => void
  readonly sectionRef?: Ref<HTMLLIElement>
}
...
export function MonthCalendarView({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      {/* Mobile: scrollable day cards (readable task list per day) */}
      <div
        ref={mobileScrollRef}
      ...
      {/* Desktop: classic 7-column month grid */}
